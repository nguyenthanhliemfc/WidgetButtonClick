...
namespace WidgetButtonClick.Droid
{
    ...
    [IntentFilter(new string[] { "com.companyname.WidgetButtonClick.ACTION_WIDGET_TURNON" })]
    [IntentFilter(new string[] { "com.companyname.WidgetButtonClick.ACTION_WIDGET_TURNOFF" })]
